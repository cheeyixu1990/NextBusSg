...
data class DbBusService(
    ...
    @ColumnInfo(name = "direction") val busDirection: Int,
...
data class DbBusStop(
    ...
    @ColumnInfo(name = "latitude") val busStopLatitude: Double,
    @ColumnInfo(name = "longtitude") val busStopLongitude: Double
)
...
data class DbBusRoute(
    ...
    @ColumnInfo(name = "opearator") val busRouteOperator: String,
    @ColumnInfo(name = "direction") val busRouteDirection: Int,
    @ColumnInfo(name = "stop_sequence") val busRouteStopSequence: Int,
    @ColumnInfo(name = "stop_code") val busRouteStopCode: String,
    @ColumnInfo(name = "distance_from_orig") val busRouteDistance: Double,
